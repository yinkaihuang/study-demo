...
public class DynamicDataSourceRegister implements ImportBeanDefinitionRegistrar, EnvironmentAware, PriorityOrdered {
    ...
    public void registerBeanDefinitions(AnnotationMetadata metadata, BeanDefinitionRegistry registry) {
        ...
        for (AnnotationAttributes value : values) {
            ...
            createAndRegisterMapperBean(registry, prefix, dbPrefix, locations, aliasesPackage, mapperScanPackages);
        }
    }

    private void createAndRegisterMapperBean(BeanDefinitionRegistry registry, String prefix, String dbPrefix, String[] locations, String aliasesPackage, String[] mapperScanPackages) {
        /**创建第一个数据源**/
        //创建DataSource数据结构
